...
<head>
    ...
    <style>
        ...
        .gradient-banner {
            /* A logistics-themed gradient (Blue to Cyan) */
...
<body>
    ...
    <div class="container-fluid h-100">
        <div class="row h-100 align-items-center">
            ...
            <div class="col-12 col-lg-5 col-md-12 p-5 text-center d-flex flex-column justify-content-center align-items-center bg-white shadow-sm">
                <img src="../assets/packit-poster.svg"
                     class="img-fluid mb-3" 
                     alt="PackIT Delivery Logo"
                    ...
                    <div class="card border-0 rounded-4" style="max-width: 700px; width: 100%;">
                        <div class="card-body p-4 p-md-5">
                                ...
                                <form>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12 col-lg-6 mb-3 mb-lg-0">
                                            ...
                                            <input type="tel" class="form-control" id="contact" placeholder="0912 345 6789">
                                        </div>
                                        <div class="col-12 col-lg-6">
                                ...
                                <form>
                                    <div class="row mb-3">
                                        <div class="col-12 col-lg-6 mb-3 mb-lg-0">
                                            ...
                                            <input type="text" class="form-control" id="houseNumber" placeholder="#42 or Unit 101">
                                        </div>
                                        <div class="col-12 col-lg-6">
                                            <label for="street" class="form-label">Street Name *</label>
                                            <input type="text" class="form-control" id="street" placeholder="Main Avenue">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12 col-lg-6 mb-3 mb-lg-0">
                                            <label for="subdivision" class="form-label">Subdivision/Village</label>
                                            <input type="text" class="form-control" id="subdivision" placeholder="Greenfield Estate">
                                        </div>
                                        <div class="col-12 col-lg-6">
                                            <label for="barangay" class="form-label">Barangay *</label>
                                            <input type="text" class="form-control" id="barangay" placeholder="Brgy. San Antonio">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <label for="landmark" class="form-label">Nearest Landmark (Optional)</label>
                                            <input type="text" class="form-control" id="landmark" placeholder="Near the Elementary School / Blue Gate">
                                            <div class="form-text">Helps our riders find you faster.</div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12 col-lg-5 mb-3 mb-lg-0">
                                            <label for="city" class="form-label">City/Municipality *</label>
                                            <input type="text" class="form-control" id="city" placeholder="Sto. Tomas">
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-3">
                                            ...
                                            <input type="text" class="form-control" id="postal" placeholder="4234">
                                        </div>
                                    </div>

                                    <div class="mt-4 p-3 bg-light rounded text-center">
                                        <p class="mb-0 small text-muted">By clicking submit, you agree to PackIT's <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a>.</p>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="button" id="submitBtn" class="btn btn-primary px-5 py-2 ms-auto" style="display: none;">
                                    Create Account
                                </button>
                            </div>
    ...
    <script>
        ...
        // Stepper Logic
        var currentStep = 1;
        const totalSteps = 2; // UPDATED: Changed from 3 to 2
        ...
        function showStep(step) {
            ...
            if (step === 1) {
                ...
                // Final Step (Now Step 2)
                backBtn.style.display = 'block';
                nextBtn.style.display = 'none';
                submitBtn.style.display = 'block'; // Show "Create Account"
            } else {
                // Middle Steps (Not used in 2-step flow, but kept for logic)
                backBtn.style.display = 'block';
                nextBtn.style.display = 'block';
                submitBtn.style.display = 'none';
            }
        ...
        document.getElementById('submitBtn').addEventListener('click', function() {
            // Here you would normally send data to a server via PHP or API
            alert('Welcome to PackIT! Registration Submitted.');
        });
