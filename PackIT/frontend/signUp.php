                                ...
                                <form>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <input type="text" class="form-control" id="landmark" placeholder="Near the Blue Gate">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            .catch(err => {
                ...
                // Fallback: If ../assets/json doesn't work, try assets/json (in case file is in root)
            ...
            provinceSelect.addEventListener('change', function() {
                ...
                // Filter cities where province_code matches
            ...
            citySelect.addEventListener('change', function() {
                ...
                // Filter barangays where city_code matches
