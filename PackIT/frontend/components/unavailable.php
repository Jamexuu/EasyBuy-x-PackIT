      ...
      <div class="d-flex align-items-start gap-3">
        ...
        <div class="flex-grow-1">
          ...
          <p class="mb-3 text-muted">
            Don't worry—your account and data are safe. This specific resource is currently
            unreachable as we update our system. We are working to restore it for you.
          </p>

          <p class="mb-3">
            If you have any suggestions, <a href="../profile.php#feedback" class="text-decoration-none">send us your feedback</a>.
          </p>
