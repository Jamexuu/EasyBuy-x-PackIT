...
<head>
  ...
  <title>Unavailable - PackIT</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
  <style> .notice-card{max-width:760px;margin:60px auto;} .notice-hero{font-size:3.5rem;line-height:1;} </style>
</head>
  ...
  <div class="card shadow-sm rounded-4 p-4">
    <div class="d-flex align-items-start gap-3">
      <div class="bg-light rounded-3 p-3 d-flex align-items-center justify-content-center" style="min-width:96px;">
        <i class="bi bi-slash-circle text-danger notice-hero"></i>
      </div>
      <div class="flex-grow-1">
        <h2 class="fw-bold mb-2">Feature Not Available</h2>
        <p class="mb-3 text-muted">Sorry — this feature or resource is not currently available in the system. We're working to provide the best experience; please try other parts of the site or come back later.</p>
