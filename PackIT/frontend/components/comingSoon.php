    ...
    <div class="card shadow-sm rounded-4 p-4">
      <div class="d-flex align-items-start gap-3">
        ...
        <div class="flex-grow-1">
          <h2 class="fw-bold mb-2">Feature Coming Soon</h2>
          <p class="mb-3 text-muted">
            We’re putting the finishing touches on this feature to make it perfect for you.
            It will be available shortly! Thanks for your patience.</p>

          <p>If you have any suggestions, <a href="../profile.php#feedback">send us your feedback</a>.
          </p>
