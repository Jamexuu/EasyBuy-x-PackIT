...
$packitIP = $_ENV['PACKIT_IP'] ?? 'localhost';
$packitLoginUrl = "http://$packitIP/EasyBuy-x-PackIT/PackIT/api/login.php";
...
if (empty($existingUser)) {
    ...
    $packitUserUrl = "http://$packitIP/EasyBuy-x-PackIT/PackIT/api/getUserDataPublic.php?email=" . urlencode($email);
