...
CREATE TABLE IF NOT EXISTS `orders` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `status` enum('order placed','waiting for courier','in transit','order arrived') NOT NULL DEFAULT 'order placed',
...
INSERT INTO `orders` (`id`, `user_id`, `status`, `total_amount`, `total_weight_grams`, `payment_method`, `shipping_fee`, `order_date`) VALUES
(7, 9, 'order placed', 160.00, 2250.00, 'cod', 50.00, '2026-01-02 17:36:59'),
(11, 9, 'order placed', 411.60, 1800.00, 'cod', 50.00, '2026-01-08 14:57:03'),
(12, 9, 'order placed', 95.20, 225.00, 'cod', 50.00, '2026-01-08 15:02:07'),
(13, 9, 'order placed', 85.84, 375.00, 'cod', 50.00, '2026-01-08 15:02:53');
...
(1, 'Chinese Pechay', 'Produce', 56.50, 50, 1, 20, 225, '200g-250g', '../Product Images/all/1.webp'),
(2, 'White Onion', 'Produce', 44.80, 50, 1, 20, 375, '350g-400g', '../Product Images/all/2.webp'),
...
(11, 'Ground Beef', 'Meat and Seafood', 100.50, 40, 1, 25, 525, '500g-550g', '../Product Images/all/11.webp'),
