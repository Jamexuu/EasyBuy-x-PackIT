...
<body>
  ...
  <div class="navbar navbar-dark fixed-bottom d-flex d-lg-none py-0" style="background: var(--gradient-color);">
    <div class="container-fluid justify-content-around py-0" style="padding-left:0;padding-right:0;">
      <a href="#"
        ...
        style=" background-color:#ffffff; width:64px; height:56px; display:flex; align-items:center;
      ...
      <a href="#" class="nav-link text-center text-white"
        style="flex:1;display:flex;align-items:center;justify-content:center;padding:0;">
        <span class="material-symbols-outlined"
