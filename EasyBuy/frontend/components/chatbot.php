...
<div class="chatbot-container position-fixed bottom-0 start-0 p-3 p-md-4 z-3">
    <button class="btn rounded-circle shadow-lg p-0" id="chatbotToggle">
        <img src="/EasyBuy-x-PackIT/EasyBuy/assets/chatbot_logo.svg" alt="" class="img-fluid">
    </button>
    ...
    <div class="chatbot-window card shadow-lg border-0 d-none rounded-4 d-flex flex-column position-fixed position-md-absolute mw-100" 
        ...
        <div class="card-header border-0 rounded-top-4" style="background-color: var(--chatbot-primary);">
            <div class="row align-items-center g-2 g-md-3 p-1 p-md-2 mx-0">
                <div class="col-auto">
                    <div class="bg-white rounded-circle d-flex align-items-center justify-content-center p-2" style="width: 40px; height: 40px;">
                        <img src="/EasyBuy-x-PackIT/EasyBuy/assets/chatbot_logo.svg" alt="" class="img-fluid w-75">
                    </div>
                </div>
            ...
            <div class="row g-2 mb-2 mx-0">
                <div class="col-auto">
                    <div class="rounded-circle d-flex align-items-center justify-content-center" 
                        ...
                        <img src="/EasyBuy-x-PackIT/EasyBuy/assets/chatbot_logo.svg" alt="" class="img-fluid" style="width: 20px;">
                    </div>
                </div>
        ...
        <div class="card-footer bg-white border-top p-2 p-md-3 rounded-bottom-4">
            <div class="row g-2 align-items-center mx-0">
                <div class="col">
                    <input type="text" id="chatInput" class="form-control rounded-pill border shadow-none px-3 py-2 small" placeholder="Send your question...">
                </div>
                <div class="col-auto">
                    <button class="btn text-white rounded-circle p-0 material-symbols-rounded d-flex align-items-center justify-content-center flex-shrink-0" 
                            id="sendBtn" style="width: 36px; height: 36px; background-color: var(--chatbot-primary);">send</button>
                </div>
            </div>
        </div>
    </div>
